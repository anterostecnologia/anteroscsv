 ...
 */
public final class AnterosCsvWriter {
    ...
    public void write(final Writer writer, final Collection<String[]> data) throws IOException {
        ...
        final AnterosCsvAppender appender = append(writer);
    ...
    /**
     * Constructs a {@link AnterosCsvAppender} for the specified File.
     *
     * @param file the file to write data to.
     * @param charset the character set to be used for writing data to the file.
     * @return a new AnterosCsvAppender instance
     * @throws IOException if a write error occurs
     * @throws NullPointerException if file or charset is null
     */
    public AnterosCsvAppender append(final File file, final Charset charset) throws IOException {
        return append(
            Objects.requireNonNull(file, "file must not be null").toPath(),
            Objects.requireNonNull(charset, "charset must not be null")
        );
    ...
    /**
     * Constructs a {@link AnterosCsvAppender} for the specified Path.
     *
     ...
     */
    public AnterosCsvAppender append(final Path path, final Charset charset) throws IOException {
    ...
    /**
     * Constructs a {@link AnterosCsvAppender} for the specified Writer.
     *
     ...
     */
    public AnterosCsvAppender append(final Writer writer) {
        return new AnterosCsvAppender(Objects.requireNonNull(writer, "writer must not be null"),
