 ...
 */
public final class AnterosCsvAppender implements Closeable, Flushable {
    ...
    AnterosCsvAppender(final Writer writer, final char fieldSeparator, final char textDelimiter,
