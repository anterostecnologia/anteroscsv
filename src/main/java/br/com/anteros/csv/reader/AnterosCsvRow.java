 ...
 */
public final class AnterosCsvRow {
    ...
    AnterosCsvRow(final long originalLineNumber, final Map<String, Integer> headerMap,
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("AnterosCsvRow{");
