 ...
 */
public final class AnterosCsvReader {
    ...
    /**
     * Reads an entire file and returns a AnterosCsvContainer containing the data.
     *
     ...
     */
    public AnterosCsvContainer read(final File file, final Charset charset) throws IOException {
        return read(
     ...
     * @throws IOException if an I/O error occurs.
     */
    public AnterosCsvContainer read(final Path path, final Charset charset) throws IOException {
    ...
    /**
     * Reads from the provided reader until the end and returns a AnterosCsvContainer containing the data.
     *
     ...
     * @throws IOException if an I/O error occurs.
     */
    public AnterosCsvContainer read(final Reader reader) throws IOException {
        final AnterosCsvParser csvParser =
            parse(Objects.requireNonNull(reader, "reader must not be null"));

        final List<AnterosCsvRow> rows = new ArrayList<>();
        AnterosCsvRow csvRow;
        ...
        csvParser.close();
        return new AnterosCsvContainer(header, rows);
    }

    /**
     * Constructs a new {@link AnterosCsvParser} for the specified arguments.
     *
     * @param path the file to read data from.
     * @param charset the character set to use - must not be {@code null}.
     * @return a new AnterosCsvParser - never {@code null}.
     * @throws IOException if an I/O error occurs.
     */
    public AnterosCsvParser parse(final Path path, final Charset charset) throws IOException {
     ...
     * @throws IOException if an I/O error occurs.
     */
    public AnterosCsvParser parse(final File file, final Charset charset) throws IOException {
        return parse(
     ...
     * @throws IOException if an I/O error occurs.
     */
    public AnterosCsvParser parse(final Reader reader) throws IOException {
        return new AnterosCsvParser(Objects.requireNonNull(reader, "reader must not be null"),
