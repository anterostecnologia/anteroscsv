 ...
 */
public final class AnterosCsvParser implements Closeable {
    ...
    AnterosCsvParser(final Reader reader, final char fieldSeparator, final char textDelimiter,
    ...
    /**
     * Reads a complete {@link AnterosCsvRow} that might be made up of multiple lines in the underlying
     * CSV file.
     *
     * @return a AnterosCsvRow or {@code null} if end of file reached
     * @throws IOException if an error occurred while reading data
     */
    public AnterosCsvRow nextRow() throws IOException {
        while (!rowReader.isFinished()) {
            ...
            return new AnterosCsvRow(startingLineNo, headerMap, fieldList);
        }
